    ...
    AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE clocking (id INT AUTO_INCREMENT NOT NULL, date DATE NOT NULL, clocking_project_id INT NOT NULL, clocking_user_id INT NOT NULL, INDEX IDX_D3E9DCCD4431A71B (clocking_project_id), INDEX IDX_D3E9DCCDA1F846FC (clocking_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, matricule VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D64912B2DC9C (matricule), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`, ENGINE=InnoDB' ) ;
